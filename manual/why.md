...
| [WHY-03] Query Basics | 97-142 | topic search, **semantic bridge**, documentation | `offset=92 limit=55` |
| [WHY-04] --commit | 144-208 | git, **linked symbols**, semantic bridge | `offset=139 limit=75` |
| [WHY-05] Output Anatomy | 210-262 | sources, **doc_symbols**, code_symbols | `offset=205 limit=62` |
| [WHY-06] Use Cases | 263-332 | examples, scenarios, workflows | `offset=258 limit=79` |
| [WHY-07] AI Operator Guide | 333-387 | mandatory, before code, compression | `offset=328 limit=64` |
| [WHY-08] Integration | 388-450 | **semantic bridge diagram**, circular flow | `offset=383 limit=72` |
| [WHY-09] Quick Reference | 452-492 | cheatsheet, patterns | `offset=447 limit=50` |

### Grep Patterns for Section Markers
```bash
grep -n "^\[WHY-" manual/why.md    # Find all sections
grep -n "WHY-04" manual/why.md     # Find --commit section
```
...
1. **Keyword matching** — Finds artifacts containing query terms
2. **Graph traversal** — Expands 1 hop to find related artifacts
3. **Semantic synthesis** — LLM synthesizes into coherent answer
4. **Source citation** — Shows IDs for all referenced artifacts
...
# → "Documentation at manual/cache.md [CACHE-03]"
...
Change: Added semantic bridge documentation - why now surfaces code AND doc symbols
=============================================================================
-->
